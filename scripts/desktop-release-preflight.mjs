...
for (const relativePath of [
  ...
  "scripts/test-release-source-lifecycle-contract.mjs",
  "scripts/test-desktop-runtime-revision-exact-token.mjs",
  "scripts/test-desktop-local-preflight-artifact-boundary.mjs",
  ...
  "scripts/rtc-e2e-shutdown.mjs",
  "scripts/test-rtc-e2e-shutdown-contract.mjs",
  "scripts/test-rtc-marker-fail-propagation-contract.mjs",
